...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(`${t.blog.checkOut} ${title} ${url}`)}`
    ...
    <div className="flex items-center gap-3">
      ...
      {typeof navigator !== 'undefined' && 'share' in navigator && (
        <button
          ...
          className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gray-200 hover:bg-gray-300 text-gray-600 transition-colors"
        >
